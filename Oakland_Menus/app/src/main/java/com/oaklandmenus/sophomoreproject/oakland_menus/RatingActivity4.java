...
/**
 * Created by Hilal on 11/29/2015.
 */
public class RatingActivity4  extends Activity implements RatingBar.OnRatingBarChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ratings_layout4);

        R_Bar = (RatingBar) findViewById(R.id.ratingBar4);


        R_Bar.setOnRatingBarChangeListener(this);


        SharedPreferences sharePref = PreferenceManager.getDefaultSharedPreferences(RatingActivity4.this);
        ...
        final Button switchact = (Button) findViewById(R.id.btn20);
        ...
        final Button switchact2 = (Button) findViewById(R.id.btn21);
        ...
        final Button switchact3 = (Button) findViewById(R.id.btn23);
        ...
        final Button switchact4 = (Button) findViewById(R.id.btn27);
    ...
    public void onRatingChanged(RatingBar ratingBar, float rating,
        ...
        Toast.makeText(RatingActivity4.this,
